...
class TestBezierBuilderSimpleCurves:
    ...
    def test_simple_bezier_curve(self):
        ...
        pdf = PDFDancer.new(token=token, base_url=base_url, page_size=PageSize.A4, orientation=Orientation.PORTRAIT)

        pdf.page(0).new_bezier() \
            .from_point(100, 200) \
            .control_point_1(150, 100) \
            .control_point_2(250, 100) \
            .to_point(300, 200) \
    ...
    def test_s_curve(self):
        ...
        pdf.page(0).new_bezier() \
            .from_point(100, 300) \
            .control_point_1(200, 100) \
            .control_point_2(300, 500) \
            .to_point(400, 300) \
...
class TestBezierBuilderDashedCurves:
    ...
    def test_dashed_bezier(self):
        ...
        pdf.page(0).new_bezier() \
            ...
            .control_point_2(300, 400) \
            .to_point(400, 300) \
            .stroke_color(Color(128, 128, 128)) \
            .stroke_width(2.0) \
            .dash_pattern([10.0, 5.0], 0.0) \
            .add()
...
class TestBezierBuilderMultipleCurves:
    ...
    def test_multiple_bezier_curves(self):
        ...
        pdf.page(0).new_bezier() \
            .from_point(50, 200) \
            .control_point_1(100, 100) \
            .control_point_2(200, 100) \
            .to_point(250, 200) \
            .stroke_color(Color(255, 0, 0)) \
            .stroke_width(2.0) \
            .add()
        ...
        pdf.page(0).new_bezier() \
            .from_point(50, 300) \
            .control_point_1(100, 400) \
            .control_point_2(200, 400) \
            .to_point(250, 300) \
        ...
        pdf.page(0).new_bezier() \
            .from_point(50, 400) \
            .control_point_1(100, 500) \
            .control_point_2(200, 300) \
            .to_point(250, 400) \
            .stroke_color(Color(0, 0, 255)) \
            .stroke_width(2.0) \
            .add()
...
class TestBezierBuilderMultiplePages:
    ...
    def test_curves_on_different_pages(self):
        base_url, token = _require_env()
        pdf = PDFDancer.new(token=token, base_url=base_url, page_size=PageSize.A4, orientation=Orientation.PORTRAIT, initial_page_count=3)
        ...
        # Curve on page 1
        pdf.page(1).new_bezier() \
            .from_point(100, 300) \
            .control_point_1(150, 200) \
            .control_point_2(250, 200) \
            .to_point(300, 300) \
            .stroke_color(Color(0, 255, 0)) \
            .stroke_width(2.0) \
            .add()
        ...
        # Curve on page 2
        pdf.page(2).new_bezier() \
            .from_point(100, 400) \
            .control_point_1(150, 300) \
            .control_point_2(250, 300) \
            .to_point(300, 400) \
            .stroke_color(Color(0, 0, 255)) \
            .stroke_width(2.0) \
            .add()
