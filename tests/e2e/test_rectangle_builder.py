...
class TestRectangleBuilderMultiple:
    ...
    def test_build_multiple_rectangles_same_page(self):
        ...
        pdf.page(0).new_rectangle() \
            .at_coordinates(200, 50) \
            .with_size(100, 80) \
            .stroke_color(Color(0, 255, 0)) \
            .add()

        pdf.page(0).new_rectangle() \
            .at_coordinates(350, 50) \
            .with_size(100, 80) \
            .stroke_color(Color(0, 0, 255)) \
            .add()
...
class TestRectangleBuilderAdvanced:
    ...
    def test_build_rectangle_with_decimal_coordinates(self):
        ...
        pdf.page(0).new_rectangle() \
            .at_coordinates(123.456, 234.567) \
            .with_size(111.222, 88.999) \
            .stroke_color(Color(0, 0, 0)) \
            .add()
...
class TestRectangleBuilderValidation:
    ...
    def test_error_when_position_not_set(self):
        ...
        assert "position" in str(exc_info.value).lower() and "at_coordinates" in str(exc_info.value).lower()
    ...
    def test_error_when_size_not_set(self):
        ...
        assert "dimensions" in str(exc_info.value).lower() and "with_size" in str(exc_info.value).lower()
